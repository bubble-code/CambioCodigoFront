...
const ResultsTable = ({ data, loading, error }) => {
  ...
  const formatearNumero = (value, decimales = 0) => {
    ...
    return isNaN(numero) ? "" : numero.toFixed(decimales).replace(".", ",");
  }
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      Cell: ({ value }) => formatearFechaES(value) || '',
      width: 100,
    },
    {
      Header: 'NPedido',
    ...
    {
      Header: 'PedidoCliente',
      accessor: 'PedidoCliente',
      Cell: ({ value }) => value || '-',
      width: 100,
    },
    {
          ...
          <div className="flex-1 flex justify-between sm:hidden">
            <button
              ...
              className={`relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md ${
                !canPreviousPage ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50'
              }`}
            >
              Anterior
            </button>
            <button
              ...
              className={`ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md ${
                !canNextPage ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50'
              }`}
            >
              Siguiente
            </button>
              ...
              <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                <button
                  ...
                  className={`relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium ${
                    !canPreviousPage ? 'text-gray-300 cursor-not-allowed' : 'text-gray-500 hover:bg-gray-50'
                  }`}
                >
                ...
                <button
                  ...
                  disabled={!canNextPage}
                  className={`relative inline-flex items-center px-2 py-2 border border-gray-300 bg-white text-sm font-medium ${
                    !canNextPage ? 'text-gray-300 cursor-not-allowed' : 'text-gray-500 hover:bg-gray-50'
                  }`}
                >
...
//   const formatearFechaES = (fechaString) => {
